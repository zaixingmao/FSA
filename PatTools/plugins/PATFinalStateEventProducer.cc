...
void PATFinalStateEventProducer::produce(edm::Event& evt,
  ...
  PATFinalStateEvent theEvent(*rho, pvPtr, verticesPtr, metPtr, metCovariance, pat::TriggerEvent(),
			      trigStandAlone, names, *trigPrescale, *trigResults, myPuInfo, genInfo, genParticlesRef,
