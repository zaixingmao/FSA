...
#     tauVetoPt20TightMVANewDMVtx   = 'vetoTaus(0.4, "pt > 20 & abs(eta) < 2.5 & tauID(\'decayModeFinding\') & tauID(\'byTightIsolationMVA3newDMwoLT\') & userFloat(\'dz\') < 0.2").size()',
    ...
    #ELECTRON VETOS
    extraelec_veto = 'vetoElectrons(0., "pt > 10 & abs(eta) < 2.5 & userInt(\'MVANonTrigWP90\') > 0.5 & abs(userFloat(\'dz\')) < 0.2 & abs(userFloat(\'ipDXY\')) < 0.045   & abs(userFloat(\'relIso\')) < 0.3").size()',
    extraelec_veto_user = 'vetoElectrons(0., "pt > 10 & abs(eta) < 2.5 & userInt(\'MVANonTrigWP90\') > 0.5 & abs(userFloat(\'dz\')) < 0.2 & abs(userFloat(\'ipDXY\')) < 0.045 & (userIso(0) + max(userIso(1) + neutralHadronIso - 0.5*userIso(2), 0))/pt < 0.3").size()',
    diElectron_veto = 'vetoDiElectron(0.15, "pt > 15 & abs(eta) < 2.5 & userInt(\'CBIDVeto\') > 0.5 & abs(userFloat(\'dz\')) < 0.2 & abs(userFloat(\'ipDXY\')) < 0.045   & abs(userFloat(\'relIso\')) < 0.3")',
