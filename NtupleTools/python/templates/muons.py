...
#     ),
    ...
    objectGenPdgId       = '? (getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).pdgId() : -999',
    objectGenMass      = '? (getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).mass() : -999',
    objectGenEta         = '? (getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).eta()   : -999',
    objectGenPhi         = '? (getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).phi()   : -999',
    objectGenPt          = '? (getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).pt()   : -999',
    objectGenVZ          = '? (getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 13, 1, 0.5, 0.5, 0, 0).vz()   : -999',
    objectGenVtxPVMatch  = 'genVtxPVMatch({object_idx})', # is PV closest vtx to gen vtx?

    objectGenTauMass      = '? (getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).mass() : -999',
    objectGenTauEta         = '? (getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).eta()   : -999',
    objectGenTauPhi         = '? (getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).phi()   : -999',
    objectGenTauPt          = '? (getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isAvailable && getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).isNonnull) ? getDaughterGenParticle({object_idx}, 15, 1, 1.0, 0.5, 0, 0).pt()   : -999',
