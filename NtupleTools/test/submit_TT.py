...
tempFile = "do_test.sh"
outFile = "do.sh"
#cmd = "submit_job.py SYNC2 make_ntuples_cfg.py channels=\"tt\" isMC=1 useMiniAOD=1 nExtraJets=6 svFit=0"
#cmd += " --campaign-tag=\"Phys14DR-PU20bx25*\" --das-replace-tuple=$fsa/MetaData/tuples/MiniAOD-13TeV.json --samples \"TTJets*\" -o %s" %tempFile
os.system(cmd)
