...
cmd = "./make_ntuples_cfg.py eventsToProcess=1:3050:304989  outputFile=myTestFile.root useMiniAOD=1 inputFiles=file:///hdfs/store/mc/Phys14DR/VBF_HToTauTau_M-125_13TeV-powheg-pythia6/MINIAODSIM/PU20bx25_tsg_PHYS14_25_V1-v2/00000/D20C1E9C-9F77-E411-B8A7-00266CF9B184.root channels=tt isMC=1 nExtraJets=10 svFit=0 "
...
tempFile = "do_test.sh"
outFile = "do.sh"
cmd = "submit_job.py SYNC_745 make_ntuples_cfg.py channels=\"tt\" isMC=1 useMiniAOD=1 nExtraJets=8 svFit=0"
