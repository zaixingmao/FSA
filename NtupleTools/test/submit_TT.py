...
cmd = "./make_ntuples_cfg.py eventsToProcess=1:1718:171763  outputFile=myTestFile.root useMiniAOD=1 inputFiles=file:///hdfs/store/mc/Phys14DR/VBF_HToTauTau_M-125_13TeV-powheg-pythia6/MINIAODSIM/PU20bx25_tsg_PHYS14_25_V1-v2/10000/6617651C-4977-E411-9156-3417EBE2F493.root channels=tt isMC=1 nExtraJets=6 svFit=0 "
...
tempFile = "do_test.sh"
outFile = "do.sh"
cmd = "submit_job.py SYNC3 make_ntuples_cfg.py channels=\"tt\" isMC=1 useMiniAOD=1 nExtraJets=6 svFit=0"
