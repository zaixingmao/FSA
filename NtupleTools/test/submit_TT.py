...
cmd = "./make_ntuples_cfg.py eventsToProcess=1:2267:226635  outputFile=myTestFile.root useMiniAOD=1 inputFiles=file:///hdfs/store/mc/Phys14DR/VBF_HToTauTau_M-125_13TeV-powheg-pythia6/MINIAODSIM/PU20bx25_tsg_PHYS14_25_V1-v2/00000/66E71D9C-9F77-E411-BFE9-00266CF9B184.root channels=tt isMC=1 nExtraJets=6 svFit=0 "
...
tempFile = "do_test.sh"
outFile = "do.sh"
cmd = "submit_job.py SYNC make_ntuples_cfg.py channels=\"tt\" isMC=1 useMiniAOD=1 nExtraJets=6 svFit=0"
cmd += " --campaign-tag=\"Phys14DR-PU20bx25*\" --das-replace-tuple=$fsa/MetaData/tuples/MiniAOD-13TeV.json --samples \"VBFHtt*\" -o %s" %tempFile
os.system(cmd)
